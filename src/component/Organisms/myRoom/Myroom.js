  ...
  return (
    <Box style={{ display: "flex", gap: "100px", padding: "60px" }} className="RoomContainer">
      ...
      <Box className="ProfileForm">
        ...
        <Box style={{
          display: "flex", alignItems: "center", gap: "30px", marginTop: "20px",
        }}
        >
          <Box>
        ...
        <Box
          style={{
            display: "flex", gap: "30px", marginTop: "20px", marginLeft: "10px",
          }}
          classNam="FormButtons"
        >
          <button style={{
            width: "105px", height: "40px", borderRadius: "8px", border: "none", fontweight: "500", backgroundColor: "#1D9BD6", color: "white", fontSize: "16px",
          }}
          >
            Save
          </button>
